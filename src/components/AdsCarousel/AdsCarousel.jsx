...
import sadiaChickenImg from "/images/sadia-chicken.png";
        ...
        <div dir={dir} className="w-full py-6 select-none">
            ...
            >
                {ads.map((ad) => (
                    <div
                        key={ad.id}
                        className="relative  w-1/4 min-w-[250px] snap-start border border-gray-200 rounded-2xl shadow-sm bg-white flex-shrink-0 hover:shadow-md transition-transform hover:scale-[1.02]"
                    >
                        <button
