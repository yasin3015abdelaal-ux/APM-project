...
const Navbar = ({ onMenuClick, onSearchClick, showProfileHover, setShowProfileHover }) => {
            ...
            <div className="flex items-center justify-between gap-2 md:gap-3">
                ...
                >
                    <input
                        ...
                        className={`w-full px-3 py-1.5 ${i18n.language === "ar" ? "pr-10" : "pl-3 pr-10"} border-2 border-main rounded-lg outline-none focus:ring-2 focus:ring-green-400 text-sm`}
                        dir={i18n.language === "ar" ? "rtl" : "ltr"}
                    />
                    <button 
                        type="submit"
                        className={`absolute cursor-pointer top-1/2 -translate-y-1/2 ${i18n.language === "ar" ? "left-2" : "right-2"} p-1 hover:bg-gray-100 rounded transition`}
                    >
                ...
                >
                    <svg width="21" height="24" viewBox="0 0 43 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div 
                    ...
                    onMouseEnter={() => window.innerWidth >= 1024 && setShowProfileHover(true)}
                    onMouseLeave={() => window.innerWidth >= 1024 && setShowProfileHover(false)}
                >
                ...
                <button
                    ...
                    aria-label="Menu"
                >
                    <span className="material-symbols-outlined text-main text-xl sm:text-2xl">menu</span>
                </button>
            </div>
        </div>
    );
