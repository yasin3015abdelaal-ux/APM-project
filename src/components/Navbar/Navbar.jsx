        ...
        <div className="flex items-center justify-between gap-2 md:gap-3">
          ...
          {isAuthenticated && (
            ...
            >
              <input
                ...
                className={`w-full px-3 py-1.5 ${i18n.language === "ar" ? "pr-10" : "pl-3 pr-10"
          ...
          {isAuthenticated && (
            <button
              ...
              className={`relative p-2 rounded-lg transition flex-shrink-0 cursor-pointer ${location.pathname === "/cart"
                  ? "bg-green-100"
                  : "hover:bg-gray-100"
                }`}
              aria-label="Cart"
            >
              <ShoppingCart className="text-main w-6 h-6" />
              {cartCount > 0 && (
          ...
          {isAuthenticated && (
            <button
              ...
              className={`relative p-2 rounded-lg transition flex-shrink-0 cursor-pointer ${location.pathname === "/favorites"
                  ? "bg-green-100"
                  : "hover:bg-gray-100"
                }`}
          ...
          {isAuthenticated && (
            <button
              ...
              className={`relative p-2 rounded-lg transition flex-shrink-0 cursor-pointer ${location.pathname === "/chats"
                  ? "bg-green-100"
                  : "hover:bg-gray-100"
                }`}
              aria-label="Messages"
            >
              <MessageCircleIcon className="text-main w-6 h-6" />
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs w-5 h-5 rounded-full flex items-center justify-center font-bold">
          ...
          {isAuthenticated && (
            <button
              ...
              className={`relative p-2 rounded-lg transition flex-shrink-0 cursor-pointer ${location.pathname === "/notifications"
                  ? "bg-green-100"
                  : "hover:bg-gray-100"
                }`}
