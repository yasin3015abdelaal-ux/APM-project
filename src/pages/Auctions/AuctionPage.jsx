...
import { auctionAPI, clearCache, getCachedAuctionProducts, getCachedAuctionRole, getCachedAuctions } from "../../api";
...
const AuctionPage = () => {
    ...
    }, [timeRemaining.isOpen, participantRole, showToast, isRTL]);
...
function ProductCard({ product, onProductClick, onContactSeller, isAuctionOpen }) {
    ...
    const handleImageError = (e) => {
        if (imgRef.current) {
            ...
            imgRef.current.nextElementSibling.style.display = 'flex';
        }
    };
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            ...
            <div className="p-2">
                ...
                <button
                    ...
                    className={`w-full py-1.5 px-2 rounded-lg transition text-xs font-medium ${
                        isAuctionOpen
...
return (
    <div className="min-h-screen bg-white" dir={isRTL ? "rtl" : "ltr"}>
        ...
        {isParticipating && (
            <div className="sticky bottom-0 left-0 right-0 bg-white border-t border-gray-200 py-3 z-40">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="flex flex-row gap-3 justify-center">
                        {participantRole !== 'buyer' && (
                            <button
                                onClick={() => { window.location.href = '/my-auctions'; }}
                                className="flex-1 bg-white border border-main text-main cursor-pointer hover:bg-main hover:text-white px-4 py-2.5 rounded-lg font-bold transition text-sm flex items-center justify-center gap-2 min-w-[140px] whitespace-nowrap"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button
                            ...
                            className={`bg-white border border-gray-300 text-gray-700 cursor-pointer hover:border-main hover:text-main px-4 py-2.5 rounded-lg font-bold transition text-sm flex items-center justify-center gap-2 min-w-[140px] whitespace-nowrap ${participantRole === 'buyer' ? 'flex-1' : 'flex-1'}`}
                        >
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
